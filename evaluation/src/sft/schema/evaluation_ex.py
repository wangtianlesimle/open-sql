...
if __name__ == '__main__':
    ...
    # 读取推测文件
    predict_data = json.load(open("/public14_data/wtl/work_point/open_sql_v1/evaluation/codellama/sft/schema/output/json/inference_sft_schema_VD.json", "r"))
    # 读取dev文件
    ...
    with open("/public14_data/wtl/work_point/open_sql_v1/evaluation/codellama/sft/schema/result/result_sft_schema_VD.json", "w") as f:
