...
def get_dev_schema_V():
    schema_info_file = "/public14_data/wtl/work_point/open_sql_v1/datasets/bird/dev/schema/schema_V.json"
    ...
    f = open("/public14_data/wtl/work_point/open_sql_v1/datasets/bird/dev/sft/schema/dev_schema_V.json", "w")
    dev_schema_F = {}
