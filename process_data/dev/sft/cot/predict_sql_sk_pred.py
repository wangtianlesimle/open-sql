...
def get_predict_sql_of_dev_data_based_on_true_label():
    ...
    f = open("/public14_data/wtl/work_point/open_sql_v1/datasets/bird/dev/sft/cot/dev_cot_predict_sql_sk_pred_schema_A_based_on_true_label.json", "w")
...
def get_predict_sql_of_dev_data_based_on_predict_label():
    ...
    f = open("/public14_data/wtl/work_point/open_sql_v1/datasets/bird/dev/sft/cot/dev_cot_predict_sql_sk_pred_schema_A_based_on_predict_label.json", "w")
    predict_sql_dev_data = {}
    for idx, data in enumerate(dev_data):
        db_name = data["db_id"]
        question = data["question"]
...
if __name__ == "__main__":
    get_predict_sql_of_dev_data_based_on_true_label()
