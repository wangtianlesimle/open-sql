...
def get_predict_sql_of_dev_data_based_on_true_label():
    ...
    f = open("/public14_data/wtl/work_point/open_sql_v1/datasets/bird/dev/sft/cot/dev_cot_predict_sql_sp_pred_schema_A_based_on_true_label.json", "w")
...
def get_predict_sql_of_dev_data_based_on_predict_label():
    schema_info_file = "/public14_data/wtl/work_point/open_sql_v1/datasets/bird/dev/schema/schema_A.json"
    schema_info = json.load(open(schema_info_file, "r"))
    ...
    predict_columns_file = "/public14_data/wtl/work_point/open_sql_v1/evaluation/codellama/sft/cot/result/result_cot_predict_columns_pred_schema_A_adv.json"
    predict_columns_data = json.load(open(predict_columns_file, "r"))
    f = open("/public14_data/wtl/work_point/open_sql_v1/datasets/bird/dev/sft/cot/codellama_infer_cot_predict_sql_sp_pred_adv.json", "w")
    predict_sql_dev_data = {}
    for idx, data in enumerate(dev_data):
        db_name = data["db_id"]
        question = data["question"]
...
if __name__ == "__main__":
    get_predict_sql_of_dev_data_based_on_predict_label()
