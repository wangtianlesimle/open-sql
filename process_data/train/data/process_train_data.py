...
# 将train data中的sql语句进行分词
def generate_train_sql_tokens():
    train_data_file = "/public14_data/wtl/work_point/open_sql_v1/datasets/bird/train/train.json"
    train_datas = json.load(open(train_data_file, "r"))
    for train_data in train_datas:
        # if train_data["question_id"] == 2:
        #     print(1)
        sql = train_data["SQL"]
        ...
        train_data["SQL_toks"] = sql_tokens
        train_data["question_toks"] = question_tokens
    json.dump(train_datas, open(train_data_file, "w"))

if __name__ == "__main__":
    generate_train_sql_tokens()