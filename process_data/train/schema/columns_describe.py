...
def get_train_describe(db_name, table_name):
    root_path = "/public14_data/wtl/work_point/open_sql_v1/datasets/bird/train/train_databases"
...
if __name__ == "__main__":
    ...
    for idx, database_name in enumerate(database_names):
        ...
        for t_idx, table in enumerate(tables):
            ...
            # 获取表对应的所有描述信息
            describe_info = get_train_describe(database_name, table_name)
    ...
    with open(columns_describe_file, 'w') as json_file:
