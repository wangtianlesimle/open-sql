...
def generate_schema_VD():
    ...
    schema_file = "/public14_data/wtl/work_point/open_sql_v1/datasets/bird/train/schema/schema_VD.json"
    ...
    for idx, database_name in enumerate(database_names):
        ...
        for t_idx, table in enumerate(tables):
            ...
            for c_idx, column in enumerate(columns):
                ...
                schema_data[database_name][table_name][column_name] = col_describe_info + ", " + columns_enumeration_values_info
