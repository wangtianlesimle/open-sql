...
"""
schema_VDT: 加上了数据类型、列描述和枚举取值等信息
"""
...
def generate_schema_VDT():
    ...
    schema_file = "/public14_data/wtl/work_point/open_sql_v1/datasets/bird/train/schema/schema_VDT.json"
    ...
    for idx, database_name in enumerate(database_names):
        ...
        for t_idx, table in enumerate(tables):
            ...
            for c_idx, column in enumerate(columns):
                ...
                schema_VDT[database_name][table_name][column_name] = column_type + ", " + \
