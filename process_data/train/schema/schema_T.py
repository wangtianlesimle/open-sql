...
def generate_schema_T():
    databases_file = "/public14_data/wtl/text2sql/datasets/bird/train/train_databases"
    database_names = [f for f in os.listdir(databases_file) if os.path.isdir(os.path.join(databases_file, f))]
    schema_file = "/public14_data/wtl/work_point/open_sql_v1/datasets/bird/train/schema/schema_T.json"
    schema_T = {}
