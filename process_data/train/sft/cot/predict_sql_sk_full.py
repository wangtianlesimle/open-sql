...
def get_predict_sql_full_of_train_data_based_on_true_label():
    count_column = 0
    ...
    train_tables_info_file = "/public14_data/wtl/work_point/open_sql_v1/datasets/bird/train/train_tables.json"
    train_tables_info_data = json.load(open(train_tables_info_file, "r"))
    # f = open("/public14_data/wtl/work_point/open_sql_v1/datasets/bird/train/sft/cot/train_cot_predict_sql_sk_full_schema_A_based_on_true_label.json", "w")
    ...
    for idx, data in enumerate(train_data):
        ...
        table_info = {}
        for table_info_data in train_tables_info_data:
...
if __name__ == "__main__":
    get_predict_sql_full_of_train_data_based_on_true_label()
