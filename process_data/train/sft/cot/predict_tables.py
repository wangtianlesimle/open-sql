...
def get_predict_tables_of_train_data():
    schema_info_file = "/public14_data/wtl/work_point/open_sql_v1/datasets/bird/train/schema/schema_D.json"
    ...
    f = open(
        "/public14_data/wtl/work_point/open_sql_v1/datasets/bird/train/sft/cot/train_cot_predict_tables_schema_D.json",
        "w")
...
if __name__ == "__main__":
    get_predict_tables_of_train_data()
