...
def get_predict_columns_of_train_data_based_on_true_tables():
    ...
    f = open("/public14_data/wtl/work_point/open_sql_v1/datasets/bird/train/sft/cot/train_cot_predict_columns_pred_schema_A.json", "w")
    ...
    for idx, data in enumerate(train_data):
        ...
        if get_used_columns_label(used_tables, used_columns, table_data[db_name]) == "" :
            continue
...
if __name__ == "__main__":
    get_predict_columns_of_train_data_based_on_true_tables()
