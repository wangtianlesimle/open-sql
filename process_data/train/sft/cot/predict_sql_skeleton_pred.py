...
def get_predict_sql_skeleton_of_train_data_based_on_true_label():
    ...
    f = open("/public14_data/wtl/work_point/open_sql_v1/datasets/bird/train/sft/cot/train_cot_predict_sql_skeleton_pred_schema_A_based_on_true_label.json", "w")
...
if __name__ == "__main__":
    get_predict_sql_skeleton_of_train_data_based_on_true_label()
